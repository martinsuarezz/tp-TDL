...
author: 
  - Grupo 8
  - Colombo, Juan Ignacio - 103471
  - Janeiro, Ignacio - 103550
  - Ramos, Federico Andrés - 101640
  - Suarez, Martín Andrés - 101540 
---
![](https://www.logolynx.com/images/logolynx/c3/c3b7ed5d007115f23b737150df873247.png
)
...
detalle utilizando librerias como `ggplot2` y `plotly`.

## ¿Por qué usar R?

- Es libre y de código abierto.
- Tiene una comunidad muy fuerte.
- Un lenguaje hecho desde la base y con una gran catidad de librerías para análisis estadístico, Machine Learning, visualización de información.
...
- Un lenguaje hecho desde la base para análisis estadís
...
- La seguridad no es fuerte del lenguaje.
- No posee soporte nativo para programación multihilo.
...
Hay tres operadores de subsetting: `[[`, `[`, y `$`.

Los operadores de subsetting interactúan de manera diferente con diferentes tipos de vectores (por ejemplo, vectores atómicos, listas, factores, matrices y marcos de datos).

El subsetting es un complemento natural para `str()`. Si bien le `str()` muestra todas las piezas de cualquier objeto (su estructura), el subsetting le permite extraer las piezas que le interesan. Para objetos grandes y complejos, le recomiendo utilizar el Visor interactivo RStudio.
...
### Otros usos del sistema de condiciones y reinicios

Aunque las condiciones y reinicios se suelen utilizar para errores, son una herramenta muy poderosa para hacer código que interactúe facilmente entre el bajo y el alto nivel.
...
Los dos lenguajes tienen una gran cantidad de librerias relacionadas a data science y visualizaciones y son fáciles de aprender. Ambos son lenguajes
interpreteados por lo que tienen rendimientos similares. En especial R se utiliza para visualizaciones
y en el campo de la estadística, mientras que Python se utiliza más en proyectos de machine learning y data science.

Pandas, una de las librerías más conocidas de dataframes para Python basa mucho de sus sistemas en R.
...
## Usos según la industria
![](images/uses.png)

## Paquetes más utilizados
![](images/packages.png)

## Estadísticas de uso de R

R se encuentra, según el último índice TIOBE (agosto 2020) como el octavo lenguaje más popular. Es un salto de 12 puestos, en comparación a agosto 2019, cuando se ubicaba en el puesto 20°.

La firma RedMonk ubica a R como el lenguaje 13° más popular a Junio de 2020

![](https://zdnet4.cbsistatic.com/hub/i/r/2020/07/28/14a50514-99c8-4a16-bfc8-16e6716fc30b/resize/1200xauto/1776e515c7f99727c28874aad3e6ae5a/rankings-over-time-2020-06-2048x16341.png)

## Comparación de salarios

R se úbica como uno de los lenguajes mejores pagos.
...
Los bancos utilizan R para modelar el riesgo de crédito y otras formas de análisis de riesgos. Mortgage Haircut Model es un modelo utilizado para hacerse cargo de una propiedad en caso 
...
2. Índice TIOBE de lenguajes más populares: https://www.tiobe.com/tiobe-index/

#### Manejo de excepciones

3. Advanced R - Hadley Wickham. Beyond Exception Handling: Conditions and Restarts
http://adv-r.had.co.nz/beyond-exception-handling.html

4. Beyond Exception Handling: Conditions and Restarts - Peter Seibel (El ejemplo original en Common Lisp) http://www.gigamonkeys.com/book/beyond-exception-handling-conditions-and-restarts.html

5. Condition Systems in an Exceptional Language - Chris Houser (Explicación del mismo ejemplo y como aplica a librerías de Clojure. La explicación aplica de manera muy similar a R) https://www.youtube.com/watch?v=zp0OEDcAro0
