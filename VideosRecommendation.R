...
setwd("/Users/Nacho/Desktop/movie_data")                      
...
while (contador < 10) {
  ...
  my.movieWatched <- as.integer(my.movieWatched)
...
recomendation <- function(newUser){
            ...
            user1 <- predicted_recommendations@items[[newUser]] #Usuario ID a recomendar
            ...
            movies_user2 #peliculas que devuelve
}            
